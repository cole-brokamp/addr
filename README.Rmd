...
Utilize options in `addr_standardize()` to extract specific address tags in a tidy manner; for example:
...
For finer control, use `addr_tag()` to generate all tagged address components:
